      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url(); ?>colors">
            ...
            <li class="nav-item nav-dropdown">
              ...
              <ul class="nav-dropdown-items">
                <li class="nav-item">
                  <a class="nav-link" href="login.php" target="_top">
                    <i class="nav-icon icon-star"></i> Login</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="register.php" target="_top">
                    <i class="nav-icon icon-star"></i> Register</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="404.php" target="_top">
                    <i class="nav-icon icon-star"></i> Error 404</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="500.php" target="_top">
                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="<?php echo base_url(); ?>assets/admin/img/avatars/1.jpg" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="<?php echo base_url(); ?>assets/admin/img/avatars/2.jpg" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="<?php echo base_url(); ?>assets/admin/img/avatars/3.jpg" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="<?php echo base_url(); ?>assets/admin/img/avatars/5.jpg" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-success"></span>
                            </div>
                          </td>
                          <td>
            ...
            <div class="list-group list-group-accent">
              ...
              <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
                <div class="avatar float-right">
                  <img class="img-avatar" src="<?php echo base_url(); ?>assets/admin/img/avatars/7.jpg" alt="admin@bootstrapmaster.com">
                </div>
                <div>Meeting with
                  <strong>Lucas</strong>
                </div>
              ...
              <div class="list-group-item list-group-item-accent-primary list-group-item-divider">
                ...
                <div class="avatars-stack mt-2">
                  ...
                  <div class="avatar avatar-xs">
                    <img class="img-avatar" src="<?php echo base_url(); ?>assets/admin/img/avatars/8.jpg" alt="admin@bootstrapmaster.com">
                  </div>
                </div>
              </div>
            </div>
